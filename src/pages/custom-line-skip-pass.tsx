...
const CustomLineSkipPass = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      title: "Success",
      description: "Custom line skip pass has been created",
    });
  };
        ...
        <div className="min-h-screen flex-1 bg-background p-8">
          <div className="container mx-auto max-w-5xl">
            <header className="mb-8">
              <h1 className="text-3xl font-semibold">Line Skip Pass Listing</h1>
...
export default CustomLineSkipPass;