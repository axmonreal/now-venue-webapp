...
const DayOfWeekLineSkipPass = () => {
  const [selectedDays, setSelectedDays] = useState<string[]>([]);

  return (
    <div className="container mx-auto p-6 max-w-6xl">
      <div className="bg-[#F7F9F7] rounded-lg p-6 mb-8">
        <h1 className="text-2xl font-semibold mb-2">Line Skip Pass Listing</h1>
        ...
        <div className="space-y-8">
          ...
          <section className="grid grid-cols-2 gap-8">
            <div>
              ...
              <Input type="number" placeholder="$20" className="bg-gray-50" />
            </div>
            <div>
              <h3 className="font-medium mb-2">Quantity</h3>
              <Input type="number" placeholder="25" className="bg-gray-50" />
            </div>
          </section>
        </div>
...
export default DayOfWeekLineSkipPass;